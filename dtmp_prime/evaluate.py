...
# NOTA: as funções transformer_predictor_order3_file / _update / _pos foram
# movidas para dtmp_prime/legacy_pegsub.py. Elas pertenciam ao app web original
# (pegsub) e liam caminhos fixos inexistentes nesta estrutura (Sequence/,
# Position/, pegsub/static/). Nenhum módulo do DTMP-Prime as utiliza.
